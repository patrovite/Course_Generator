...
public class CheckBoxNodeRenderer implements TreeCellRenderer {
	...
	/*
	 * private JPopupMenu createPopupMenu(final AbstractLayer layer) { JMenuItem
	 * menuItem;
	 * 
	 * //Create the popup menu. if(layer.isVisibleTexts()) menuItem = new
	 * JMenuItem("hide texts"); else menuItem = new JMenuItem("show texts");
	 * JPopupMenu popup = new JPopupMenu(); popup.add(menuItem);
	 ...
	 * layer.setVisibleTexts(visible); if (layer instanceof LayerGroup) { LayerGroup
	 * group = (LayerGroup) layer; if (group.getLayers() != null) for (AbstractLayer
	 * al : group.getLayers()) setVisibleTexts(al, visible); } }
	 */
}