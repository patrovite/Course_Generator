...
public interface Attributed {
	...
	/**
	 * @return The URL for the attribution image. Null if no image should be
	 *         displayed.
	 */
	Image getAttributionImage();

	/**
	 * @return The URL to open when the user clicks the attribution image. When
	 *         return value is null, the image is still displayed (provided
	 *         getAttributionImage() returns a value other than null), but the image
	 *         does not link to a website.
	 */
	String getAttributionImageURL();

	/**
	 * @return The attribution "Terms of Use" text. In case it returns null, but
	 *         getTermsOfUseURL() is not null, a default terms of use text is used.
	 */
	String getTermsOfUseText();

	/**
	 * @return The URL to open when the user clicks the attribution "Terms of Use"
	 *         text.
	 */
