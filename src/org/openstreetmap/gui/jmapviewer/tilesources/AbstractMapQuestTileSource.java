...
public class AbstractMapQuestTileSource extends AbstractOsmTileSource {
	...
	// MapQuest logo in base64:
	// http://developer.mapquest.com/content/osm/mq_logo.png
	private static final String LOGO_BASE64 = "iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJl"
			...
			+ "MKq4GP79/w1OHCC/v/x6Exzv+x9MhbiOEeh3LAZQnBeYGCgEjJRmZ4AAAwCE6rplT3Ba/gAAAABJRU5ErkJg" + "gg==";
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.openstreetmap.gui.jmapviewer.tilesources.AbstractOsmTileSource#
	 * getTermsOfUseURL()
	 */
	@Override
