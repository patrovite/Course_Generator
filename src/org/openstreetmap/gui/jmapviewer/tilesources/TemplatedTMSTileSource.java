...
public class TemplatedTMSTileSource extends TMSTileSource {
	...
	public static final String[] ALL_PATTERNS = { PATTERN_HEADER, PATTERN_ZOOM, PATTERN_X, PATTERN_Y, PATTERN_Y_YAHOO,
			PATTERN_NEG_Y, PATTERN_SWITCH };
	...
	public String getTileUrl(int zoom, int tilex, int tiley) {
		...
		String r = this.baseUrl.replaceAll(PATTERN_ZOOM, Integer.toString(finalZoom))
				.replaceAll(PATTERN_X, Integer.toString(tilex)).replaceAll(PATTERN_Y, Integer.toString(tiley))
