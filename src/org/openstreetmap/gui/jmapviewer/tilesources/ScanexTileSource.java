...
public class ScanexTileSource extends TMSTileSource {
	...
	/*
	 * To solve inverse formula latitude = f(y) we use Newton's method. We cache
	 * previous calculated latitude, because new one is usually close to the old
	 * one. In case if solution gets out of bounds, we reset to a new random value.
	 */
