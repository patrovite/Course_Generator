...
public class frmSearchCurve extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		panelFinalTime.setBorder(
				javax.swing.BorderFactory.createTitledBorder(bundle.getString("frmSearchCurve.panelFinalTime"))); // TODO
																													// bundle...
		panelFinalTime.setOpaque(true);
		panelFinalTime.setLayout(new GridBagLayout());
		Utils.addComponent(paneGlobal, panelFinalTime, 0, 0, 1, 1, 0, 1, 10, 10, 0, 10,
		...
		Utils.addComponent(panelFinalTime, hsFinalTime, 0, line++, 1, 1, 1, 0, 5, 0, 0, 0,
		...
		Utils.addComponent(panelFinalTime, btSearchCurve, 0, line, 1, 1, 1, 0, 5, 0, 0, 5, GridBagConstraints.WEST,
				GridBagConstraints.BOTH);

		// == Progress panel
		panelProgress = new JPanel();
		panelProgress.setBorder(
				javax.swing.BorderFactory.createTitledBorder(bundle.getString("frmSearchCurve.panelProgress"))); // TODO
																													// bundle
		panelProgress.setOpaque(true);
		panelProgress.setLayout(new GridBagLayout());
		Utils.addComponent(paneGlobal, panelProgress, 0, 1, 1, 1, 0, 1, 0, 10, 0, 10,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.BOTH);
		...
		Utils.addComponent(panelProgress, progressBar, 0, line, 1, 1, 1, 1, 0, 0, 0, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.BOTH);

		// == Result panel
		panelResult = new JPanel();
		panelResult.setBorder(
				javax.swing.BorderFactory.createTitledBorder(bundle.getString("frmSearchCurve.panelResult"))); // TODO
																												// bundle
		panelResult.setOpaque(true);
		panelResult.setLayout(new GridBagLayout());
		Utils.addComponent(paneGlobal, panelResult, 0, 2, 1, 1, 0, 1, 10, 10, 20, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.BOTH);
		...
		Utils.addComponent(panelResult, lbFoundCurve1, 0, line, 1, 1, 1, 0, 0, 5, 2, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL);

		lbFoundTime1 = new javax.swing.JLabel();
		lbFoundTime1.setText(bundle.getString("frmSearchCurve.lbFoundTime1.Text"));
		Utils.addComponent(panelResult, lbFoundTime1, 1, line, 1, 1, 1, 0, 0, 10, 0, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL);
		...
		Utils.addComponent(panelResult, lbFoundTime1Val, 2, line, 1, 1, 1, 0, 0, 5, 2, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL);
		...
		Utils.addComponent(panelResult, btFoundSelect1, 3, line, 1, 1, 0, 0, 0, 10, 0, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.BOTH);
		...
		Utils.addComponent(panelResult, lbFoundCurve2, 0, line, 1, 1, 1, 0, 0, 5, 2, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL);

		lbFoundTime2 = new javax.swing.JLabel();
		lbFoundTime2.setText(bundle.getString("frmSearchCurve.lbFoundTime2.Text"));
		Utils.addComponent(panelResult, lbFoundTime2, 1, line, 1, 1, 1, 0, 0, 10, 0, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL);
		...
		Utils.addComponent(panelResult, lbFoundTime2Val, 2, line, 1, 1, 1, 0, 0, 5, 2, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL);
		...
		Utils.addComponent(panelResult, btFoundSelect2, 3, line, 1, 1, 0, 0, 0, 10, 0, 0,
				GridBagConstraints.BASELINE_LEADING, GridBagConstraints.BOTH);
		...
		Utils.addComponent(paneGlobal, jPanelButtons, 0, 3, GridBagConstraints.REMAINDER, 1, 0, 0, 0, 0, 0, 0,
