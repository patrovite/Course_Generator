...
public class SaxParamHandler  extends DefaultHandler {
    ...
    */
   public int readDataFromParam(String filename, ParamData pdata) throws SAXException, IOException, ParserConfigurationException{
       paramdata=pdata;
       ...
       if (f.isFile() && f.canRead()) {
           if (mode==0) paramdata.data.clear();
           parser.parse(f, this);
       }
       else
